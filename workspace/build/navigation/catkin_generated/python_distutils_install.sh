...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/navigation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/navigation/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/navigation" \
    install \
    --root="${DESTDIR-/}" \
