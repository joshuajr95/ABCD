...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/motor_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/motor_control/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/motor_control" \
    install \
    --root="${DESTDIR-/}" \
