...
set(MSG_I_FLAGS "-Igps:/home/ubuntu/Desktop/ABCD/workspace/src/gps/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/Desktop/ABCD/workspace/src/gps/msg/gps_data.msg" NAME_WE)
add_custom_target(_gps_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gps" "/home/ubuntu/Desktop/ABCD/workspace/src/gps/msg/gps_data.msg" ""
)
...
_generate_msg_cpp(gps
  "/home/ubuntu/Desktop/ABCD/workspace/src/gps/msg/gps_data.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps\")")
  # install generated code
  install(
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps/.+/__init__.pyc?$"
  )
endif()
