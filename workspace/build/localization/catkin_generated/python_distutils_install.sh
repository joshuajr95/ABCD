...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/localization"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/localization/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/localization" \
    install \
    --root="${DESTDIR-/}" \
