...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/collision_detection"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/collision_detection/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/collision_detection" \
    install \
    --root="${DESTDIR-/}" \
