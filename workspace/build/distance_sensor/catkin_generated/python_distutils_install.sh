...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/distance_sensor"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/distance_sensor/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/distance_sensor" \
    install \
    --root="${DESTDIR-/}" \
