...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/executive"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/executive/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/executive" \
    install \
    --root="${DESTDIR-/}" \
