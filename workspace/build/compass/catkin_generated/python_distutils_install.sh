...
echo_and_run cd "/home/ubuntu/Desktop/ABCD/workspace/src/compass"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/Desktop/ABCD/workspace/src/compass/setup.py" \
     \
    build --build-base "/home/ubuntu/Desktop/ABCD/workspace/build/compass" \
    install \
    --root="${DESTDIR-/}" \
